...
(member_expr member: ["assert" "async" "await" "builtin" "const" "else" "enum" "extern" "false" "fn" "for" "from" "if" "impl" "in" "interface" "io" "let" "match" "nondet" "null" "of" "pub" "return" "self" "switch" "true" "type" "use" "where"] @variable.other.member)
...
(field name: ["assert" "async" "await" "builtin" "const" "else" "enum" "extern" "false" "fn" "for" "from" "if" "impl" "in" "interface" "io" "let" "match" "nondet" "null" "of" "pub" "return" "self" "switch" "true" "type" "use" "where"] @variable.other.member)
(record_field name: ["assert" "async" "await" "builtin" "const" "else" "enum" "extern" "false" "fn" "for" "from" "if" "impl" "in" "interface" "io" "let" "match" "nondet" "null" "of" "pub" "return" "self" "switch" "true" "type" "use" "where"] @variable.other.member)
