...
> **This repository is a generated mirror — do not edit it here.** The source is `toolchain/grammars/tree-sitter-masterbelt` in the masterbelt monorepo; this tree is assembled and published from there (`build/publish-tree-sitter.sh`). Version `0.1.20260615-nightly.97fa27c`, cut from masterbelt commit `97fa27c159a87b2643a5d2631affee257e1d4756` — the grammar ships under the same version as the language it tracks.
...
- **Go** — `go get github.com/masterbelt/tree-sitter-masterbelt@v0.1.20260615-nightly.97fa27c` (`bindings/go`, cgo over `src/parser.c`).
