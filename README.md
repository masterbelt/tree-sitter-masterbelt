...
> **This repository is a generated mirror — do not edit it here.** The source is `toolchain/grammars/tree-sitter-masterbelt` in the masterbelt monorepo; this tree is assembled and published from there (`build/publish-tree-sitter.sh`). Version `0.1.20260614-nightly.8dbf6aa`, cut from masterbelt commit `8dbf6aabda1533c983ffee45a5a2cbacbb61e4c2` — the grammar ships under the same version as the language it tracks.
...
- **Go** — `go get github.com/masterbelt/tree-sitter-masterbelt@v0.1.20260614-nightly.8dbf6aa` (`bindings/go`, cgo over `src/parser.c`).
