...
VERSION := 0.1.20260612-nightly.2df8a77
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/masterbelt '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/masterbelt
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/masterbelt
